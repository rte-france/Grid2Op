__all__ = ["OpponentSpace", "BaseActionBudget", "BaseOpponent", "UnlimitedBudget", "OpponentWithConverter",
           "RandomLineOpponent"]
...
from grid2op.Opponent.OpponentWithConverter import OpponentWithConverter
