...
class TestDanglingRef(unittest.TestCase):
    ...
    def test_dangling_reference(self):
        ...
        assert nb_backend_after_close == 2, f"there should be 2 backends after close, but we found {nb_backend_after_close}"
        assert nb_ppnet_after_close == 4, f"there should be 4 pp networks after close, but we found {nb_ppnet_after_close}"
